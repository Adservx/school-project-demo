    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          {/* CTA Skeleton */}
          <div className="bg-apex-midnight rounded-lg shadow-lg p-8 mt-8">
            <div className="h-8 bg-apex-platinum/20 rounded-lg w-1/2 mx-auto mb-4 animate-pulse"></div>
            <div className="h-4 bg-apex-platinum/10 rounded-lg w-2/3 mx-auto mb-6 animate-pulse"></div>
            <div className="h-12 bg-apex-gold/30 rounded-lg w-48 mx-auto animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
